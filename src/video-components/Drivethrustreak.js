    ...
    <div className="player-wrapper">
      ...
      <div className="wrap-video-content">
        <ReactPlayer
          ...
          url="https://player.vimeo.com/video/774810252?h=3031d5729f&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
          width="558px"
          height="314.36"
          // width="30%"
          // height="20%"
        ...
        <div className="p-wrapper">
          ...
          <p className="video-paragraph">
            ...
            outnumber people almost 4 to 1. This excerpt features Bourdain and
            Mattos visiting a drive-thru steak restaurant in Punta Del Este,
            Uruguay.
          </p>
        </div>
      </div>

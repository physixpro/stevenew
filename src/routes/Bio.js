    ...
    <div className="bio-box">
      ...
      <div className="bio-wrapper">
        ...
        <p id="bio-paragraph">
          ...
          film for most major broadcast and streaming networks. <br /> Recent
          work includes showrunning the forthcoming hip-hop docuseries “Rap
          Caviar Presents,” (a co-production of Spotify and Hulu), producing and
          writing the Showtime documentary films “You’re Watching Video Music
          Box” (directed by Nas), “Rolling Like Thunder” and “Bitchin’: The
          Sound and Fury of Rick James,” (which was nominated for Critics Choice
          Documentary and Hollywood Critics Association awards), directing on
          the final season of the Emmy and Peabody- winning documentary series
          "Anthony Bourdain: Parts Unknown," and directing multiple episodes of
          "Broken," an investigative series on consumer products for Netflix.{" "}
          <br />
          ...
          "The Vice Guide to Everything" for VICE and MTV, directing and
          producing episodes of "Death Row Stories" and "Morgan Spurlock’s
          Inside Man" for CNN, directing "Invisible Killers," a three-part
          special on viruses for Discovery Channel, producing "New York: A
          Documentary Film" and "Eugene O’Neill" for PBS’s American Experience
          series. Steve’s feature-length documentary film "Carvalho’s Journey"
          ...
          Festival des Cultures Juives in Paris, France.
          <br />
          ...
          film aired nationally on PBS. Steve has also completed a number of
          film projects for brands and clients, including Red Bull, Domus, the
          American Institute of Architects and Random House, Inc. A graduate of
          Columbia University, Steve is a member of the Writer’s Guild of
          America, East, and an adjunct assistant professor at Hofstra
